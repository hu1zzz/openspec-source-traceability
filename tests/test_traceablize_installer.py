...
class TraceablizeInstallerTest(unittest.TestCase):
    def test_installs_traceable_skills_schema_and_removes_legacy_tool_files(self):
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertNotIn("## Mandatory termination gate", generated_apply)
            self.assertNotIn("Before any final reply, pause report, or end-of-turn", generated_apply)
            self.assertNotIn("progress ledger", generated_apply)
