...
This skill derives three traceability-aware skills from the target project's currently installed official OpenSpec skills and deploys an optional requirement-packaging skill. It never replaces official skills. The generated propose skill creates a source inventory internally; the generated verify skill performs semantic evidence review without a fixed-format validator or GUI.
