---
name: traceablize
description: 当 OpenSpec 项目需要生成可追溯 propose、sync-specs 与 verify-with-report skill，以及来源清单 Schema 时使用。
license: MIT
metadata:
  version: "2.1-public"
---
...
本 skill 从目标项目**当前安装的官方 OpenSpec skill**派生三个可追溯 skill，并追加来源追踪规则；不会覆盖官方 skill。来源核验由生成的 verify skill 完成，不安装固定格式 Python 校验器或 GUI。
